...
public class Bestiary {
    ...
    public static final EnemyTemplate BOG_RAT = new EnemyTemplate(
        ...
        List.of(new LootEntry(ItemCatalog.RAT_TAIL, 40)));
    ...
    public static final EnemyTemplate MARSH_WOLF = new EnemyTemplate(
        ...
        List.of(new LootEntry(ItemCatalog.WOLF_PELT, 40)));
    ...
    public static final EnemyTemplate HIGHWAY_BANDIT = new EnemyTemplate(
        ...
        List.of(new LootEntry(ItemCatalog.STOLEN_COIN_PURSE, 40), new LootEntry(ItemCatalog.STUDDED_LEATHER, 15)));
    ...
    public static final EnemyTemplate MIRE_GHOUL = new EnemyTemplate(
        ...
        List.of(new LootEntry(ItemCatalog.GHOUL_ICHOR, 40), new LootEntry(ItemCatalog.IRON_WARAXE, 15)));
